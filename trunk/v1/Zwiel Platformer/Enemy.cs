...
namespace Zwiel_Platformer
{
    ...
    class Enemy
    {
        ...
        public Color Tint
        {
            get { return sprite.Tint; }
            set { sprite.Tint = value; }
        }
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            Rectangle toDraw = new Rectangle(0, 0, (int)((float)healthBarFill.Width * Health / MaxHealth), healthBarFill.Height),
                hpDisp = new Rectangle(BoundingRectangle.X - 40, BoundingRectangle.Y - healthBar.Height, healthBar.Width / 3,
                    healthBar.Height / 3),
